...
impl IntoOwlCtx for obo::TermClause {
    ...
    fn into_owl(self, ctx: &mut Context) -> Self::Owl {
        match self {
            ...
            obo::TermClause::Name(name) => Some(owl::AnnotatedAxiom::from(
                owl::AnnotationAssertion {
            ...
            obo::TermClause::Namespace(ns) => Some(owl::AnnotatedAxiom::from(
                owl::AnnotationAssertion {
                    annotation_subject: ctx.current_frame.clone(),
                    annotation: owl::Annotation {
                        annotation_property: ctx.build.annotation_property(
            ...
            obo::TermClause::AltId(id) => Some(owl::AnnotatedAxiom::from(
                owl::AnnotationAssertion {
                    annotation_subject: ctx.current_frame.clone(),
                    annotation: owl::Annotation {
                        annotation_property: ctx.build.annotation_property(
            ...
            obo::TermClause::Def(desc, xrefs) => Some(
            ...
            obo::TermClause::Comment(comment) => Some(owl::AnnotatedAxiom::from(
                owl::AnnotationAssertion {
                    annotation_subject: ctx.current_frame.clone(),
                    annotation: owl::Annotation {
                        annotation_property: ctx.build.annotation_property(
            ...
            obo::TermClause::Subset(subset) => Some(owl::AnnotatedAxiom::from(
                owl::AnnotationAssertion {
                    annotation_subject: ctx.current_frame.clone(),
                    annotation: owl::Annotation {
                        annotation_property: ctx.build.annotation_property(
            ...
            obo::TermClause::PropertyValue(pv) => Some(
                owl::AnnotatedAxiom::from(
                    owl::AnnotationAssertion{
                        annotation_subject: ctx.current_frame.clone(),
            ...
            obo::TermClause::IsA(supercls) => Some(
                owl::AnnotatedAxiom::from(
                    owl::SubClassOf {
            ...
            obo::TermClause::EquivalentTo(cid) => Some(
                owl::AnnotatedAxiom::from(
            ...
            obo::TermClause::DisjointFrom(cid) => Some(
                owl::AnnotatedAxiom::from(
                    owl::DisjointClasses(
                        vec![
                            owl::ClassExpression::from(owl::Class(ctx.current_frame.clone())),
            ...
            obo::TermClause::IsObsolete(b) => Some(owl::AnnotatedAxiom::from(
                owl::AnnotationAssertion {
                    annotation_subject: ctx.current_frame.clone(),
                    annotation: owl::Annotation {
                        annotation_property: ctx.build.annotation_property(
            ...
            obo::TermClause::ReplacedBy(id) => Some(owl::AnnotatedAxiom::from(
                owl::AnnotationAssertion {
                    annotation_subject: ctx.current_frame.clone(),
                    annotation: owl::Annotation {
                        annotation_property: ctx.build.annotation_property(
            ...
            obo::TermClause::Consider(id) => Some(owl::AnnotatedAxiom::from(
                owl::AnnotationAssertion {
                    annotation_subject: ctx.current_frame.clone(),
                    annotation: owl::Annotation {
                        annotation_property: ctx.build.annotation_property(
            ...
            obo::TermClause::CreatedBy(c) =>Some(owl::AnnotatedAxiom::from(
                owl::AnnotationAssertion {
                    annotation_subject: ctx.current_frame.clone(),
                    annotation: owl::Annotation {
                        annotation_property: ctx.build.annotation_property(
            ...
            obo::TermClause::CreationDate(dt) => Some(owl::AnnotatedAxiom::from(
                owl::AnnotationAssertion {
                    annotation_subject: ctx.current_frame.clone(),
                    annotation: owl::Annotation {
                        annotation_property: ctx.build.annotation_property(
